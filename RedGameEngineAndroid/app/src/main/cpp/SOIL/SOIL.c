...
/**Android**/
unsigned int SOIL_asset_load_OGL_texture(const char *filename,int force_channels,unsigned int reuse_texture_ID,unsigned int flags)
{
	/*	variables	*/
	unsigned char* img;
	...
	img = SOIL_asset_load_image( filename, &width, &height, &channels, force_channels );
